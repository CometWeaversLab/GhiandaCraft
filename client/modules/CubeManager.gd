...
# textures
@onready var textureGrassTop = load("res://client/assets/Textures/Grass_Top.png");
@onready var textureGrassSide = load("res://client/assets/Textures/Grass_Side.png");
@onready var textureGrassBottom = load("res://client/assets/Textures/Grass_Bottom.png");

# shaders
@onready var shaderBasic = load("res://client/shaders/basic.gdshader");
